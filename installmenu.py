...
DEPENDENCIES = {
    "HWHACKTOOLS_INSTALL": ["BACKPORTS_INSTALL", "DEVTOOLS_INSTALL", "PYTHON_INSTALL", "MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "PULSEVIEW_INSTALL": ["BACKPORTS_INSTALL", "DEVTOOLS_INSTALL", "PYTHON_INSTALL", "MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "HASHCAT_INSTALL": ["DEVTOOLS_INSTALL", "PYTHON_INSTALL", "MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "REVERSETOOLS_INSTALL": ["DEVTOOLS_INSTALL", "PYTHON_INSTALL", "MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "USERTOOLS_INSTALL":["PYTHON_INSTALL", "MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "DEVTOOLS_INSTALL":["PYTHON_INSTALL", "MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "GO_INSTALL":["MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "FP_DEVTOOLS_INSTALL":["PYTHON_INSTALL", "MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "FP_USERTOOLS_INSTALL":["MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "FP_ELECTRONICSTOOLS_INSTALL":["MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "FP_3DTOOLS_INSTALL":["MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "PWSH_INSTALL":["MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
    "MICROSOFT_APT":["MM_BUTTONS_CONFIGURE", "MENU_IS_COMPOSE", "KB_SHORTCUTS", "GNOME_DASH_TO_PANEL", "GNOME_PANEL_LENGTH_DYNAMIC", "GNOME_HIDE_OVERVIEW", "GNOME_CAFFEINE"],
}
